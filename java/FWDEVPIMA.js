...
var FWDEVPIMA = function(
		...
		*/
		...
		_s.onContentProgress = function(e){
			...
			_s.totalTime = totalTime = FWDEVPUtils.formatTime(totalTimeInSeconds);
			...
			_s.totalPercentPlayed = curTimeInSeconds/totalTimeInSeconds;
		}
		...
		_s.onAllAdsComplete = function(){
			...
			prt.sendGAPlayedAdEvent(_s.source, _s.totalPercentPlayed,  _s.totalTime);
		}
